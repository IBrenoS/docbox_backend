...
Crie uma nova branch: git checkout -b feature/nome_da_sua_feature.
Realize suas modificações e faça commit: git commit -m 'Adiciona nova feature'.
Envie para o repositório remoto: git push origin feature/nome_da_sua_feature.
